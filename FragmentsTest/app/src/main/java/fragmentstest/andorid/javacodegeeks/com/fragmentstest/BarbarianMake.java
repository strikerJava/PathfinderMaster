...
public class BarbarianMake extends Character{
    ...
    public void level2Upgrade(){
        ...
        //SpecialSkills = SpecialSkills.concat("Rage Power(1) | Uncanny Dodge | ");
        baseFortSave = 3;
        baseRefSave = 0;
        baseWillSave = 0;
        LevelSavesUpdate();
    ...
    public void level3Upgrade(){
       ...
       // SpecialSkills = SpecialSkills.concat("Trap Sense +1 | ");
        baseFortSave = 3;
        baseRefSave = 1;
        baseWillSave = 1;
        LevelSavesUpdate();
    ...
    public void level4Upgrade(){
        baseAttackBonus[0] = 4;
        addToSpecialSkills("Rage Power(2)");
        //SpecialSkills = SpecialSkills.concat("Rage Power(2) | ");
        baseFortSave = 4;
        baseRefSave = 1;
        baseWillSave = 1;
    ...
    public void level5Upgrade(){
        baseAttackBonus[0] = 5;
        addToSpecialSkills("Improved uncanny Dodge");
        //SpecialSkills = SpecialSkills.concat("Improved uncanny Dodge |  ");
        HitDieUpdate(hitDie1D, characterMods[2]);

    }
    public void level6Upgrade(){
        baseAttackBonus[0] = 6;
        baseAttackBonus[1] = 1;
        addToSpecialSkills("Rage Power(3)");
        replaceASpecialSkill("Trap Sense(+1)", "Trap Sense(+2)");
        //SpecialSkills = SpecialSkills.concat("Rage Power(3) | Trap Sense +2 ");
        baseFortSave = 5;
        baseRefSave = 2;
        baseWillSave = 2;
        LevelSavesUpdate();
    ...
    public void level7Upgrade(){
        baseAttackBonus[0] = 7;
        baseAttackBonus[1] = 2;
        addToSpecialSkills("Damage Reduction(1/-)");
        //SpecialSkills = SpecialSkills.concat("Damage Reduction (1/-) |  ");
        HitDieUpdate(hitDie1D, characterMods[2]);

    }
    public void level8Upgrade(){
        baseAttackBonus[0] = 8;
        baseAttackBonus[1] = 3;
